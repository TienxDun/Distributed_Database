...
<head>
    ...
    <meta name="description"
        content="HUFLIT Distributed Database - Full CRUD Interface for managing distributed database system with SQL Server and MongoDB">
        ...
        <div class="content-wrapper">
            ...
            <div id="sinhvien" class="tab-content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="sinhvien-id" placeholder="Ví dụ: 25DH000001, 24DH000002"
            ...
            <div id="ctdaotao" class="tab-content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="ctdaotao-khoa" placeholder="Ví dụ: CNTT hoặc Công nghệ thông tin"
            ...
            <div id="dangky" class="tab-content">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="dangky-masv" placeholder="Ví dụ: 25DH000001, 24DH000002"
                ...
                <div class="query-grid">
                    <div class="query-card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="global-masv-1" placeholder="Ví dụ: 25DH000001"
                                onkeydown="if(event.key==='Enter') callGlobalQuery(1)">
                        </div>
                    ...
                    <div class="query-card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="global-query-2" placeholder="Ví dụ: CNTT"
                                onkeydown="if(event.key==='Enter') callGlobalQuery(2)">
                        </div>
                    ...
                    <div class="query-card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="global-masv-3" placeholder="Ví dụ: 25DH000001"
                                onkeydown="if(event.key==='Enter') callGlobalQuery(3)">
                        </div>
