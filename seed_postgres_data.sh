...
echo "  - Giao diện Dashboard: http://localhost:8081/"
echo "  - Logs Hệ thống:     http://localhost:8081/logs-ui"
echo "  - Thống kê:          http://localhost:8081/stats-ui"
echo "  - Quản trị Admin:    http://localhost:8081/maintenance-ui"
